...
CUDA_VISIBLE_DEVICES=1 python train_rnc.py --model_name ./checkpoint/Supervised_group_lr_0.001_epoch_300_bs_128_groups_10.pth --lr 1e-9 --encoder_lr 1e-10 --soft_label --asymm
echo ' linear lr 1e-9 encoder 1e-10'