...
python train.py --groups 25 --sigma 0.5 --la True --tau 0.5 --lr 0.0001 --ranked_contra True --temp 5 --data_dir /home/ruizhipu/scratch/regression/imbalanced-regression/imdb-wiki-dir/data 