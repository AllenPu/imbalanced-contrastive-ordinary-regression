...
CUDACUDA_VISIBLE_DEVICES=2 python train_rnc_loss.py --single_output --epoch 100  --norm  --scratch
CUDACUDA_VISIBLE_DEVICES=2 python train_rnc_loss.py --single_output --epoch 100  --scratch
