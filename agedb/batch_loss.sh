CUDA_VISIBLE_DEVICES=2 python train_rnc_loss.py --single_output --epoch 100  --norm  --pretrained  --weight_norm
CUDA_VISIBLE_DEVICES=2 python train_rnc_loss.py --single_output --epoch 100  --pretrained --weight_norm
