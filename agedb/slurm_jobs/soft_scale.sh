...
python train.py --lr 0.001 --groups 10 --epoch 250 --temp 0.05 --sigma 1 --ranked_contra --soft_label --ce --scale 0.95  --diversity 1 --output_file softlabel_s_0.95d1__1127_