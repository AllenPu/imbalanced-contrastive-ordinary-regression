...
#python train.py --lr 0.0015 --groups 20 --epoch 350 --temp 0.02 --sigma 2 --ranked_contra --soft_label --ce --diversity 0.1 --output_file softlabel_diversity0.1e350_1113_
python train.py --lr 0.001 --groups 10 --epoch 250 --temp 0.05 --sigma 1 --ranked_contra --soft_label --ce --scale 0.95  --diversity 0.1 --output_file softlabel_s_0.95d0.1__1127_